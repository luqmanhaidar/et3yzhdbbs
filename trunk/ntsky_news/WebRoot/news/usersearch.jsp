...
<jsp:useBean id="personal" class="com.ntsky.news.Personal"/>
<jsp:useBean id="Pagination" class="com.ntsky.common.Pagination"/>
<jsp:useBean id="searchN" scope="page" class="com.ntsky.news.SearchNews">
    ...
    <td height="449" align="center" valign="top"> 
      <table width="100%" height="449" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999" style="border-collapse: collapse">
        <tr> 
            ...
            由于本站刚刚建立，也许大家在使用的时候会遇到很多的bug，请大家发<a href="mailto:lovehere2@163.net">E-mail</a>给我！或是到<a href="http://note.ntsky.com">留言区</a>给我留言 
            </marquee></td>
          </tr>
          <tr> 
              ...
              <tr> 
                <td height="90" valign="top" bordercolor="#FF0000"> 
                  ...
                  <p style="margin-top: 3; margin-bottom: 3">&nbsp;&nbsp;您的IP:<font color="red"><%=request.getRemoteAddr()%></font></p>
                    <p style="margin-top: 3; margin-bottom: 3">&nbsp;&nbsp;上次登陆时间:<br>&nbsp;&nbsp;&nbsp;&nbsp;<font color="red"><%=personal.timePersonal()%></font></p>
