...
<jsp:useBean id="linkNews" scope="page" class="com.ntsky.news.LinkNews"/>
<jsp:useBean id="counter" scope="page" class="com.ntsky.common.Counter"/>
<jsp:useBean id="newsShow" scope="page" class="com.ntsky.news.NewsShow"/>
...
<jsp:useBean id="SessionManager" scope="page" class="com.ntsky.servlet.SessionManager"/>
