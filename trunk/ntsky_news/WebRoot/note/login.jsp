...
<jsp:useBean id="noteA" scope="page" class="com.ntsky.persistence.NOTEAdmin"/>
	<jsp:setProperty name="noteA" property="*"/>
<jsp:useBean id="servlet" scope="page" class="com.ntsky.servlet.DOServlet"/>
<jsp:useBean id="manager" class="com.ntsky.news.note.Manager"/>
    ...
    <table border="0" cellpadding="0" cellspacing="0" bordercolor="#111111" width=280 height=107>
      <tr>
       ...
       <table border="1" cellpadding="0" cellspacing="0"bordercolor="#99BB99" width="100%" height="92" style=" border-collapse: collapse">
          ...
          <tr>
            <td width="100%" height=32 colspan=2>　　　　　　　　<input type="submit" name="Submit" value="登陆">　　　　<input type="reset" name="reset" value="重置"></td>
          </tr>
          </form>
        </table>
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" bordercolor="#111111" width=500>
    ...
    <a href="http://www.ntsky.com"><font color="#FFFFFF">www.NTsky.com </font>
    </a> </TD>
