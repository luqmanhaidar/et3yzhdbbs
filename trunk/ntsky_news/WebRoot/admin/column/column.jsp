...
<jsp:setProperty name="Column" scope="page" property="*"/>
<jsp:useBean id="NEWSClass" scope="page" class="com.ntsky.persistence.NEWSClass"/>
<jsp:setProperty name="NEWSClass" scope="page" property="*"/>
