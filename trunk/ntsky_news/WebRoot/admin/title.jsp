  ...
  <TR>
	...
	%>
      <TABLE align=center cellPadding=0 cellSpacing=0 width=158>
        <TBODY>
        <TR>
              <TD background=../images/admin/title3.gif class=menu_title height=25 id=menuTitle1 onclick=showsubmenu(1) onmouseout="this.className='menu_title';" onmouseover="this.className='menu_title2';"><SPAN>类别管理</SPAN> 
              </TD>
        </TR>
        <TR>
                ...
                <DIV class=sec_menu style="WIDTH: 158px"> 
                  <TABLE align=center cellPadding=0 cellSpacing=0 width=135>
                    <TBODY>
                      ...
                      <TR> 
                        <TD height=20><a href="column/kind.jsp" target=main>类管理</a></TD>
                      </TR>
                      <TR> 
                        <TD height=20>专题管理</TD>
                      </TR>
                    </TBODY>
                  </TABLE>
                </DIV>
                ...
                <DIV class=sec_menu style="WIDTH: 158px">
                  <TABLE align=center cellPadding=0 cellSpacing=0 width=135>
                    <TBODY>
                      ...
                      <TR> 
                        <TD height=20><A href="main.jsp" target=main>用户组信息管理</A></TD>
                      </TR>
                    </TBODY>
                  </TABLE>
                </DIV>
      ...
      <TABLE align=center cellPadding=0 cellSpacing=0 width=158>
        <TBODY>
        <TR>
              <TD background=../images/admin/title5.gif class=menu_title height=25 id=menuTitle1 onclick=showsubmenu(3) onmouseout="this.className='menu_title';" onmouseover="this.className='menu_title2';"><SPAN>文件管理</SPAN> 
              </TD>
        </TR>
        <TR>
              <TD height="100" id=submenu3> 
                <DIV class=sec_menu style="WIDTH: 158px">
                  <TABLE align=center cellPadding=0 cellSpacing=0 width=135>
                    <TBODY>
                      <TR> 
                        <TD height=20><A href="news/news.jsp" target=main>添加文章 
                          </a></TD>
                      </TR>
                      <TR> 
                      ...
                      <TR> 
                        <TD height=23><a href="news/newslist.jsp" target=main>修改删除</a></TD>
                      </TR>
                      <TR> 
     ...
     &nbsp; 
        ...
        <TBODY>
        <TR>
              <TD background=../images/admin/title7.gif class=menu_title 
          height=25 id=menuTitle1 onmouseout="this.className='menu_title';" 
          onmouseover="this.className='menu_title2';"><SPAN>新技术天地信息</SPAN> </TD>
            </TR>
        <TR>
          <TD>
            <DIV class=sec_menu style="WIDTH: 158px">
            <TABLE align=center cellPadding=0 cellSpacing=0 width=135>
              <TBODY>
              <TR>
                <TD height=20>&nbsp;<BR>版权所有：<BR><A href="http://www.NTsky.com/" 
                  target=_blank>
                          新技术天地</A><BR>
                          永久域名：<BR><A 
                  href="http://www.NTsky.com/" 
                  target=_blank>
                          www.NTsky.com</A><BR>
                          <BR></TD></TR>
			   </TBODY>
