...
<jsp:useBean id="usr" scope="page" class="com.ntsky.news.manage.Usr"/>
<%
	if(usr.adminPurview(adminName)>0)
		servlet.responseUrl(response,"../../error/error.jsp");
%>
<jsp:useBean id="newsA" scope="page" class="com.ntsky.persistence.NEWSAdmin"/>
<jsp:setProperty name="newsA" scope="page" property="*"/>
<% 
	/**
	 *增加用户
	 */
...
<table width="96%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td align="center">&nbsp;
      <%=usr.strPurview(tableAdmin.getPurview())%></a>
      </td>
