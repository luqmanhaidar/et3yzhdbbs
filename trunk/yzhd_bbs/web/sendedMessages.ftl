      ...
      <div>
        ...
        <table align="center" cellpadding="0" class="ltable" cellspacing="1" style="margin:0px;width:100%;">
          ...
          <tr class="ltrv">
            ...
            <td width="8%"><a href="deleteMessage-sender.action?messageId=${message.id}"><img src="images/delete.gif" alt="" width="45" height="18" /></a></td>
          </tr>
          </#list>
          </form>
          ...
          <tr class="ltrv">
            <td colspan="6" align="left" style="padding-left:10px;"><input type="checkbox" name="checkbox2" value="checkbox" onClick="if(this.checked){Forms.checkedAllBox('messageList');}else{Forms.unCheckedAllBox('messageList');}"/>
              选中全部的短消息<input type="button" value="删除选中的短消息" name="agree" class="b" onClick="System.batchExecute('messageList','确认删除选中的短消息？','deleteMoreMessage-sender.action');"/><!--<input type="button" value="清空全部短消息" name="agree" class="b"/>--></td>
          </tr>		  
        </table>
      </div>
      <!-- explain begin -->
