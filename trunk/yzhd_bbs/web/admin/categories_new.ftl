  ...
  <form action="updateCategory.action" method="post" id="categoryForm" onSubmit="return Validator.validate(this,'admin');">
    ...
    <div class="content">
      ...
      <!--<div class="ibox">
        ...
        <div class="iv">-->
		  <input name="displayOrder" type="hidden" class="t" value="${category.displayOrder}" size="4"/>
       <!--</div>
      </div>   -->
	    <div class="box3" style="text-align:center; clear:both">
	      <div>
	        <input type="submit" value="更新文章类别" name="agree" class="b"/>
    ...
    <div class="content">
      ...
      <!--<div class="ibox">
       ...
       <!-- </div>
	    ...
	    <div class="box3" style="text-align:center; clear:both">
	      <div>
	        <input type="submit" value="添加文章类别" name="agree" class="b"/>
			<input type="reset" value="重置" name="agree" class="b"/>
	      </div>
	    </div>      	  
    </div>
...
<div class="box1">
  ...
  <div class="lbox1" style="padding:0px;">
    ...
    <div class="llbox" style="text-align:left;border-right:0px;overflow :hidden;height:26px;"><a href="#" title="${category.name}">${category.name}</a></div>
  </div>
  </#list>
</div>
