...
<%@ page import="com.ntsky.bbs.util.page.PermissonUtil" %>
...
<%
	...
	PermissonUtil pu=new PermissonUtil(object);
 %>
<div class="dtree">
  ...
  <script type="text/javascript">
	<!--
		...
		d.add(0,-1,'论坛管理');
		/*===========================================================================*/
		<%if(pu.isPermisson("1_1")||pu.isPermisson("1_6")||pu.isPermisson("1_7")||pu.isPermisson("1_8")){ %>
		d.add(101,0,'常规管理');
		<%}%>
		<%if(pu.isPermisson("1_1")){ %>
		...
		*/
		/*===========================================================================*/
		<%if(pu.isPermisson("6_1")||pu.isPermisson("6_2")){ %>
		d.add(6,0,'其他模块');
		<%}%>
		<%if(pu.isPermisson("6_1")){ %>
		d.add(61,6,'公告管理','announcements.action');
		<%}%>
		<%if(pu.isPermisson("6_2")){ %>
