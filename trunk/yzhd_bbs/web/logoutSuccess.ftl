...
<div style="height: auto;" class="info3">
    ...
    <table width="460" cellspacing="10" cellpadding="0" border="0">
      <tbody><tr>
        <td height="30" align="center" class="f-red4"><img width="31" height="31" align="absmiddle" src="images/error1.gif"/> 退出成功</td>
      </tr>
      <tr>
        <td style="line-height: 22px;">
            ...
            <ul><li><a href="index.action">返回首页</a></li>
                        ...
                        <br/>
                        <h5 id="moveInfo">本页面将在2秒后自动返回首页</h5>
     </div>
  ...
  <script type="text/javascript">
	//<![CDATA[
 	var move = function(num) {
		spareTime = secs-num; 
		document.getElementById("moveInfo").innerText = "本页面将在"+spareTime+"秒后自动返回首页"; 
		if(spareTime==0){
