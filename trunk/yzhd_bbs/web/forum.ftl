...
<head>
<title>${application["basic"]["bbsName"]?if_exists}-帖子列表</title>
...
<div class="right">
    ...
    <#assign onlineUserSingleton = OnlineUserSingleton.getInstance()>
   
<img src="images/icon3.gif">
总在线<span class="f-red2">${totalUser?int}</span>人，
有<span class="f-red2">${onlineUsers.size()?int}</span>位会员；
本版<span class="f-red2">${onlineUserSingleton.forumGuests}</span>人在线，
会员<span class="f-red2">${onlineUserSingleton.forumUsers}</span>人
    </div>
    </div>
    ...
    <div class="new1"><img src="images/icon4.gif"> <span class="f-red1">本版公告：</span>
    <marquee style="width:90%" scrollamount='1' scrolldelay='30' direction="left"
