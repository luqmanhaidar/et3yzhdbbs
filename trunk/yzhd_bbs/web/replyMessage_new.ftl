...
<script type="text/javascript">
	...
	window.onload = function(){
		replaceMyTextarea("content","Basic",".","400");
	};
...
<TABLE cellSpacing=10 cellPadding=0 width=700 border=0>
  <TBODY>
    ...
    <TD width=400><INPUT name="receiver" type="text" class=headline id="receiver" style="WIDTH: 400px" value="<#if !req.getParameter("forward")?exists>${message.sender}</#if>"
      maxLength=20 > </TD>
    <TD width=150></TD></TR>
  <TR>
    <TD class=sj width=112>标　题：</TD>
    <TD width=400><INPUT class="headline" type="text" style="WIDTH: 400px" 
      maxLength=20 name="title" id="title" value="RE:${message.title}"></TD>
    <TD width=150></TD></TR>
  <TR>
    <TD class=sj vAlign=center>内　容：</TD>
    <TD rowSpan=2>
     <textarea name="content" style="WIDTH: 400px; HEIGHT: 260px" id="content">${message.sender}在${message.sendTime}的消息中写道 : <br/>${message.content}</textarea>
