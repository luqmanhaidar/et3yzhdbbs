...
<%
	try{
		...
		iu.setSaveDirectory("UserFiles/"+user.getId()+"/");
		...
		//iu.setImageWidth(120);
		//String sourceImage = StringUtil.applyRelativePath(pageContext.getServletContext().getRealPath("/"),file.getFilePath()+file.getFileName());
		//	iu.zoomImageByWidth(sourceImage,sourceImage);
