...
%>
<div class="box1">
  <div class="title"> 上传角色标识图片 </div>
	<form action="<%=request.getContextPath()%>/common/doUploadRoleIcon.jsp" method="post" onSubmit="return Validator.Validate(this,2)" enctype="multipart/form-data">
    ...
    <div class="content">
      <div class="ibox">
        ...
        <div class="iv">
          ...
          <span class="red">选择角色标识图片</span> </div>
      </div>
    </div>
    <!-- end #content -->
    <div class="box3" style="text-align:center; clear:both">
      <div>
        <input type="submit" value="上传角色标识图片" name="agree" class="b"/>
      </div>
    </div>
  </form>
</div>
<!-- end #basic info -->
<!-- upload roleicon begin -->
