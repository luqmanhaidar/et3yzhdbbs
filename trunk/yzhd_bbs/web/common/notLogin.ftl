		    ...
		    <form action="login.action" method="post" id="login" onSubmit="return Validator.validate(this);">
		      <div class="content">
		        ...
		        <div class="ibox">
		          ...
		          <div style="padding-top:6px;"><img src="servlet/validateImg" alt="验证码,看不清楚?请点击刷新验证码" style="cursor:pointer;height:16px;" onclick="this.src='servlet/validateImg'"/></div>
		        </div>
