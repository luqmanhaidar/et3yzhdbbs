    ...
    <div id="tabmainbox">
      ...
      <div>
        ...
        <div class="box1" style="margin:0px;">
          ...
          <form action="admin-createCategory.action" method="post" id="categoryForm" onSubmit="return Validator.validate(this);">
            ...
            <div class="content">
              ...
              <div class="ibox">
                ...
                <div class="iv">
                  <input name="displayOrder" type="text" class="t" value="0" size="4"/> 值越大,位置越前</div>
              </div>  
            </div>
            <!-- end #content -->
            <div class="box3" style="text-align:center; clear:both">
              <div>
                <input type="submit" value="添加类别" name="agree" class="b"/>
              </div>
            </div>
          </form>
        </div>
