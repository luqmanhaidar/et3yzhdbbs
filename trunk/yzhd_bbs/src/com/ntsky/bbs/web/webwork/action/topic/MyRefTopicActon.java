 ...
 * @link www.ntsky.com
 * 
 * @version $Revision: 1.2 $ $Date: 2008/10/24 06:05:32 $
 */
public class MyRefTopicActon extends TopicActionSupport {
	...
	public String execute() throws Exception {
		...
		try{		
			...
			QueryResult queryResult = topicService.getRefTopics(super.getSessionUser().getId().intValue(), 1, new Pagination(getPaginationStart(),SystemConfig.getInstance().getIntPropertyValue(Symbols.PAGINATION,Symbols.PAGINATION_TOPIC)));
