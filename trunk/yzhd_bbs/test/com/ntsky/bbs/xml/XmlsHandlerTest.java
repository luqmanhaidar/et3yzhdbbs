...
public class XmlsHandlerTest extends DefaultHandler{

	private final static Logger __logger = Logger.getLogger(XmlsHandler.class.getName());
    
	private Map xmlFileMap = null; 
	
	public void startDocument() throws SAXException {
        if(__logger.isDebugEnabled())
            __logger.debug("******开始解析WEB-INF/config/Xmls.xml文件*******");
    ...
    public void endDocument() throws SAXException {
        if(__logger.isDebugEnabled())
            __logger.debug("******解析WEB-INF/config/Xmls.xml文件结束*******");        
    }
