...
<body>
<div align=center>
<form name="form1" action="vote_edit_save.jsp" method="post">
<table border=0 width="90%" cellspacing="0" cellpadding="0" align="center">
<tr height=28>
<td><u>投票管理</u>>><u>投票修改</u></td>
</tr>
<tr height=10>
<td></td>
</tr>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="594" id="table1">
	<tr>
		...
		<td width="476" height="35"><textarea name="question" cols="50" rows="5"><%=rs.getString("question") %></textarea>
		<input type="hidden" name="qid" value="<%=qid %>"/></td>
	</tr>
	<%
	...
	<tr>
		...
		<td width="476" height="35"><input type="text" name='item<%=num %>' size="60" value="<%=rs.getString("item")%>">
		</td>
	</tr>
	<%
	num++;
	...
	<tr>
		<td width="115" align="center" height="35">项&nbsp;目&nbsp;<%=num %></td>
		<td width="476" height="35"><input type="text" name='item<%=num %>' size="60">
		</td>
	</tr>
	<%
	num++;
