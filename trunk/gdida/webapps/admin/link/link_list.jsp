...
<table border=0 width="90%" align="center" cellspacing="1" cellpadding="1" bgcolor="#336699">
  <tr>
	...
	链接标题:<input name="title" type="text" value="<%=Page.output(stitle) %>" size="25">
	所属分类:<input name="type" type="text" value="<%=Page.output(stype) %>" size="25">
...
<table width="90%" align="center">
  <tr>
    ...
    <input type=button value="增加链接" onClick="location='link_add.jsp'"></td>
    <td width="41%">
      <div align="right">
...
<table width="90%" border="0" cellpadding="2" cellspacing="1" bgcolor="#336699" align="center" height="25">
    <tr bgcolor="#FFFFFF">
      <td width="40%" align="center" height="25">链接标题</td>
      <td width="40%" align="center" height="25">所属分类</td>
...
%>
      ...
      <td height="25"><a href='link_edit.jsp?lid=<%=rs.getInt("ILINKID") %>'>编辑</a>
		<a href=javascript:if(confirm('确定删除!'))location='link_del.jsp?lid=<%=rs.getInt("ILINKID") %>'>删除</a></td>
  	</tr>
<%
    }
}
