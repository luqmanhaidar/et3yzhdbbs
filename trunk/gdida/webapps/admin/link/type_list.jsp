...
if( stitle!= null && !stitle.equals("")){
    sCondition = sCondition + " and STYPENAME like '%" + stitle + "%'";
}
...
int rowCount = Table.getRecordCount("j_linktype", "1=1 " + sCondition);
String strSql = "SELECT * FROM j_linktype WHERE ITYPEID>0 " + sCondition +" order by ITYPEID DESC";
ResultSet rs = null;
...
<table width="90%" align="center">
  <tr>
    ...
    <input type=button value="增加分类" onClick="location='type_add.jsp'"></td>
    <td width="41%">
      <div align="right">
...
<table width="90%" border="0" cellpadding="2" cellspacing="1" bgcolor="#336699" align="center" height="25">
    <tr bgcolor="#FFFFFF">
      <td width="70%" align="center" height="25">分类标题</td>
...
%>
      ...
      <td height="25"><p align="left"><%=rs.getString("STYPENAME") %></td>
      <td height="25"><a href='type_edit.jsp?lid=<%=rs.getInt("ITYPEID") %>'>编辑</a>
		<a href=javascript:if(confirm('确定删除!'))location='type_del.jsp?lid=<%=rs.getInt("ITYPEID") %>'>删除</a></td>
  	</tr>
<%
    }
}
