...
<table width="90%" align="center">
  <tr>
    ...
    <input type=button value="增加合作伙伴" onClick="location='partner_add.jsp'"></td>
    <td width="41%">
      <div align="right">
...
<table width="90%" border="0" cellpadding="2" cellspacing="1" bgcolor="#336699" align="center" height="25">
    <tr bgcolor="#FFFFFF">
      <td width="37%" align="center" height="25">合作伙伴</td>
      <td  align="center" height="25">伙伴链接</td>
      <td width="11%" align="center" height="25">图片</td>
