...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="594" id="table1" height="700">
	<tr>
		...
		<td width="476" height="37"><input type="text" name="stitle" size="45" dataType="Require" re="请填写标题" value="<%=gdie.getInfoTitle() %>"></td>
	</tr>
	<tr>
		<td width="115" align="center" height="35">栏&nbsp;&nbsp;&nbsp; 目</td>
		<td width="476" height="35"><input type=hidden name='moduleid' value='<%=gdie.getModuleId() %>'><input type=text name='modulename' value='<%=gdie.getModuleName() %>' readonly dataType="Require" re="请选择信息栏目">
		<input value='选择' type=button onclick='AddArea("../module/module.jsp?master=2")'>
		</td>
	</tr>
	<tr>
