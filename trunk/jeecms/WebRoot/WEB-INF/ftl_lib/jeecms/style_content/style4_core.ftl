...
<div id="roll-${RLID}" style="overflow:hidden;height:${rollDisplayHeight}px;" onmouseover="clearInterval(proll${RLID}.pevent)" onmouseout="proll${RLID}.pevent=setInterval(function(){proll${RLID}.roll.call(proll${RLID})},proll${RLID}.rollSpeed)">
