...
document.write('<param name="movie" value="${sysResRoot}/com_tag/focus0.swf"/>');
...
document.write('<embed src="${sysResRoot}/com_tag/focus0.swf" width="'+width+'" height="'+swf_height+'" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>');
