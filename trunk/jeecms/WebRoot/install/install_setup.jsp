<%@ page contentType="text/html; charset=gbk" language="java"
	import="com.jeecms.core.util.Install,java.util.*"%>
...
<%
	...
	String resDomain = request.getParameter("resDomain");
	
	String dbFileName = "/install/db/jeecms-db-2.1.0-beta.sql";
	String initFileName = "/install/db/jeecms-init-2.1.0-beta.sql";
	...
	//更新配置
	Install.updateConfig(dbHost,dbPort,dbName,dbUser,dbPassword,domain,cxtPath,port,resDomain);
	//处理数据库配置文件
...
<table width="600" align="center" style="border:#106DBA 1px solid; margin-top:8%;">
  <tr>
  ...
  <tr>
    <td height="280" align="left" bgcolor="#F0F8FD" style="padding:10px; line-height:1.7em;">
	恭喜您，系统已经安装成功！<br/>
	<span class="STYLE1">请重启TOMCAT服务。只有重启TOMCAT服务之后，安装才能生效。</span><br/>
