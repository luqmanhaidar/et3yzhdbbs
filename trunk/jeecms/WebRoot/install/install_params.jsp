  ...
  <tr>
    <td bgcolor="#D1E9FA"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="73%" height="30" class="f14b">2、系统参数设置<span style="color:#FF0000">（环境要求：jdk1.6或以上、tomcat6.0或以上、mysql5.0或以上）</span></td>
      </tr>
      <tr>
  ...
  <tr>
    <td height="400" align="center" bgcolor="#F0F8FD"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="22%" align="left"><input name="dbHost" type="text" class="input" id="dbHost" value="localhost" /></td>
      ...
      <tr>
        ...
        <td align="left"><input name="dbName" type="text" class="input" id="dbName" value="jeecms_2_1_0_beta" /></td>
				<td align="left">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="30" align="right">资源域名：</td>
        <td align="left"><input name="resDomain" type="text" class="input" value=""/></td>
				<td align="left">如不使用远程附件，请留空</td>
      </tr>
    </table></td>
  </tr>
  <tr>
