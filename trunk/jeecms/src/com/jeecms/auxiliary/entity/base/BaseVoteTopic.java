...
public abstract class BaseVoteTopic  implements Serializable {
	...
	public void addTorecords (com.jeecms.auxiliary.entity.VoteRecord voteRecord) {
		if (null == getRecords()) setRecords(new java.util.TreeSet<com.jeecms.auxiliary.entity.VoteRecord>());
		getRecords().add(voteRecord);
	}
	...
	public void addToitems (com.jeecms.auxiliary.entity.VoteItem voteItem) {
		if (null == getItems()) setItems(new java.util.TreeSet<com.jeecms.auxiliary.entity.VoteItem>());
		getItems().add(voteItem);
	}
