...
/**
 * This is an object that contains data related to the arti_ctg table.
...
public abstract class BaseArtiCtg  implements Serializable {

	public static String REF = "ArtiCtg";
	 ...
	 */
	public BaseArtiCtg (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.article.entity.ArtiCtg)) return false;
		else {
			com.jeecms.article.entity.ArtiCtg artiCtg = (com.jeecms.article.entity.ArtiCtg) obj;
			if (null == this.getId() || null == artiCtg.getId()) return false;
			else return (this.getId().equals(artiCtg.getId()));
		}
	}
