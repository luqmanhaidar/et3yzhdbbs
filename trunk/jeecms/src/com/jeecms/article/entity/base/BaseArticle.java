...
public abstract class BaseArticle  implements Serializable {
	...
	public BaseArticle (
		java.lang.Long id,
		com.jeecms.article.entity.ArtiCtg ctg,
	...
	private com.jeecms.article.entity.ArtiCtg ctg;
	...
	/**
	 * Return the value associated with the column: ARTICTG_ID
	 */
	public com.jeecms.article.entity.ArtiCtg getCtg () {
		return ctg;
	}

	/**
	 * Set the value related to the column: ARTICTG_ID
	 * @param ctg the ARTICTG_ID value
	 */
	public void setCtg (com.jeecms.article.entity.ArtiCtg ctg) {
		this.ctg = ctg;
	}
